                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values)=>this.handleSubmit(values)}>
                            <Row className="form-group">   
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" name="firstname" id="firstname" className="form-control" placeholder="First Name" validators={ {required, minLength: minLength(3), maxLength: maxLength(15)} } />
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".lastname" name="lastname" id="lastname" className="form-control" placeholder="Last Name" validators={ {required, minLength: minLength(3), maxLength: maxLength(15)} }/>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" name="telnum" id="telnum" className="form-control" placeholder="Tel. Number" validators={ {required, minLength: minLength(3), maxLength: maxLength(15), isNumber} }/>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    className="form-control" placeholder="Email ID" validators={ {required, validEmail} }/>
