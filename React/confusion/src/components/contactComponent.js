                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" name="firstname" id="firstname" className="form-control" placeholder="First Name" />
                                </Col>
                            </Row>
                            <Row className="form-group">
                                <Label htmlFor="lastname" md={2}>Last Name</Label>
                                <Col md={10}>
                                    <Control.text name="lastname" id="lastname" model=".lastname" className="form-control" placeholder="Last Name" 
                                    />
                                </Col>
                            </Row>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" name="telnum" id="telnum" className="form-control" placeholder="Tel. Number"
                                    />
                                </Col>
                            </Row>
                            <Row className="form-group">
